...
app.model({ namespace: 'project', ...(require('/Users/skjin/firefighter-dashboard/src/models/project.js').default) });
app.model({ namespace: 'setting', ...(require('/Users/skjin/firefighter-dashboard/src/models/setting.js').default) });
app.model({ namespace: 'user', ...(require('/Users/skjin/firefighter-dashboard/src/models/user.js').default) });
}
